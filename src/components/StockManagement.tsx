                    ...
                    <td className="p-4 text-right">
                      <div className="inline-flex items-center justify-end gap-2">
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-cyan-300 transition-colors inline-flex items-center gap-1.5 text-xs font-medium"
                        >
                        ...
                        {used > 0 && (
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg bg-rose-950/40 hover:bg-rose-900/60 text-rose-300 border border-rose-800/40 transition-colors inline-flex items-center gap-1.5 text-xs font-medium"
                            title="Purge Used Keys"
                          >
                            <Trash2 className="w-3.5 h-3.5 shrink-0" />
                            <span>Purge Used</span>
                          </button>
                        )}
                      </div>
                    </td>
