          ...
          <table className="w-full text-left text-xs">
            <thead className="bg-slate-950/80 text-slate-400 uppercase font-semibold border-b border-slate-800">
              <tr>
                ...
                <th className="p-4">Quick Credit</th>
                ...
                filtered.map((r) => (
                  <tr key={r.id || r.docId} className="hover:bg-slate-950/40 transition-colors">
                    ...
                    <td className="p-4 space-x-1.5">
                      <button
                        onClick={() => onQuickAddBalance(r.docId || r.id, 100)}
                        className="px-2.5 py-1 rounded-md bg-slate-800 hover:bg-emerald-950/60 hover:text-emerald-300 text-slate-300 border border-slate-700 font-mono transition-colors"
                      >
                        +₹100
                      </button>
                      <button
                        onClick={() => onQuickAddBalance(r.docId || r.id, 500)}
                        className="px-2.5 py-1 rounded-md bg-slate-800 hover:bg-emerald-950/60 hover:text-emerald-300 text-slate-300 border border-slate-700 font-mono transition-colors"
                      >
                        +₹500
                      </button>
                      <button
                        onClick={() => onQuickAddBalance(r.docId || r.id, 1000)}
                        className="px-2.5 py-1 rounded-md bg-slate-800 hover:bg-emerald-950/60 hover:text-emerald-300 text-slate-300 border border-slate-700 font-mono transition-colors"
                      >
                        +₹1000
                      </button>
                    ...
                    <td className="p-4 text-right space-x-2">
                      {r.activeDeviceId && onResetDeviceLock && (
                        <button
                          ...
                          className="px-2.5 py-1.5 rounded-lg bg-teal-950/60 text-teal-300 hover:bg-teal-900/80 border border-teal-500/40 transition-colors inline-flex items-center gap-1 font-medium text-xs"
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-lg bg-rose-950/40 text-rose-400 hover:bg-rose-900/60 border border-rose-800/40 transition-colors inline-flex items-center justify-center"
